...
void main(int argc, char** argv) {
	...
	/*char *test_values[10];
	test_values[0] = "LADHOU000000";
	test_values[1] = "LADHOU000000";
	test_values[2] = "LADHOU000001";
	test_values[3] = "LADHOU000001";
	test_values[4] = "LADHOU000001";
	test_values[5] = "LADHOU000001";
	test_values[6] = "LADHOU001001";
	test_values[7] = "LADHOU001002";
	test_values[8] = "LADHOU001002";
	test_values[9] = "LADHOU001002";
	*/
	...
	while(1) {
		...
		/*if ( strcmp(result_clone,result) != 0)
		{
			printf("result changed: %s",result);
			print_seq(teams);
			usleep(500);
			print_seq(scores);
			usleep(500);
		...
		result_clone = memcpy(result_clone, result, 12);
		*/
